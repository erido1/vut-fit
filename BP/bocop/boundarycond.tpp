...
#include "header_boundarycond"
{
	...
	// Final conditions
	boundary_conditions[8] = final_state[0];
	boundary_conditions[9] = final_state[2];
	boundary_conditions[10] = final_state[3];
	boundary_conditions[11] = final_state[4];
	boundary_conditions[12] = final_state[5];
}
